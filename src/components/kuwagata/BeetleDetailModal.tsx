...
import { formatYen, genderColor, splitPairAmount, todayStr } from "@/lib/kuwagataUtils";
        ...
        <div className="overflow-y-auto flex-1 px-5 py-5 space-y-5">
          ...
          {beetle.soldPriceYen != null ? (
            ...
            <div className="bg-[#d7e0b8]/60 rounded-2xl p-3.5 space-y-2.5">
              ...
              />
              {canSellAsPair && (
                <label className="flex items-center gap-2 text-xs font-semibold text-[#77644b] px-0.5">
                  <input
                    type="checkbox"
                    checked={sellAsPair}
              ...
              {sellAsPair && sellForm.price && (
                <p className="text-xs text-[#8b7a64] px-0.5">
                  {(() => {
